...
$string['error:votequestiononly'] = 'You can only mark that you have the same question on a question, not on an answer or comment.';
$string['error'] = 'Error!';
...
$string['setting_defaultfullscreen'] = 'Open in fullscreen by default';
$string['setting_defaultfullscreen_help'] = 'If enabled, the PDF will open in fullscreen when the user enters the resource.';
...
$string['usevotes'] = "Allow users to mark that they have the same question (questions only).";

$string['view'] = 'Document';
$string['votes'] = 'Same question';
$string['voteshelpicon'] = 'Same question';
$string['voteshelpicon_help'] = 'How many people marked that they have the same question.';
$string['voteshelpicontwo'] = 'Same question';
$string['voteshelpicontwo_help'] = 'For your questions: how many people have the same question. (Not used for answers.)';
