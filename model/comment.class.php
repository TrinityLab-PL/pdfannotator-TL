...
class pdfannotator_comment {
    ...
    public static function create($documentid, $annotationid, $content, $visibility, $posttype, $parentid, $cm, $context) {
        ...
        // New viewer may submit plain text without draft item, so keep this optional.
        $draftitemid = optional_param('pdfannotator_addcomment_editoritemid', 0, PARAM_INT);
        ...
        $datarecord->timecreatedts = $datarecord->timecreated;
    ...
    public static function read($documentid, $annotationid, $context) {
        ...
        foreach ($comments as $data) {
            ...
            $comment->timecreatedts = $data->timecreated;
